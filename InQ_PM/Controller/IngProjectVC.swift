...
class IngProjectVC: UIViewController {
...
extension IngProjectVC : ProjectManagerDelegate {
...
extension IngProjectVC : UITableViewDelegate, UITableViewDataSource {
